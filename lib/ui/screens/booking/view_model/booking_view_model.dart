...
/// BookingViewModel - combines countdown UI logic with booking/return business logic.
///
/// MVVM refactoring: merged previous BookingState into this ViewModel to create
/// a single source of truth. All booking/return operations route through here.
/// UI calls methods via context.read() and watches state via context.watch().
class BookingViewModel extends ChangeNotifier {
  // ========== UI Context / Countdown (kept from original) ==========
  Bike? selectedBike;
  ...
  // ========== UI Context Methods (kept from original) ==========
  ...
  // ========== Booking/Return Methods (moved from BookingState) ==========
    // ========== Validation Methods ==========
    /// Validates if a station has available bikes for booking.
    /// Called by UI (MapScreen) during bike selection.
    /// Returns true if bikes are available, false otherwise.
